...
```{r}
#| label: plot-rapide
plot(srtm, main = "MNT SRTM 30 arc-sec du Cameroun (élévation en m)")
```
...
ggplot(srtm_df) +
  ...
  coord_fixed() +
  labs(title = "MNT SRTM 30 arc-sec du Cameroun",
       subtitle = "Source : geodata::elevation_30s('CMR') · NASA/USGS SRTM") +
  theme_minimal()
```
