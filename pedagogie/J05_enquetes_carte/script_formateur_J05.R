...
## Referent : J.S. Alogo
##
## CE FICHIER EST LE MIROIR DE demo_formateur_J05.qmd : meme code, meme ordre,
...
##
## Ce rapport est le miroir exécuté de script_formateur_J05.R : chaque
## section montre le code et sa sortie. Ce dossier est autonome : ouvrez-le
## directement dans RStudio (ou double-cliquez le .qmd). Les données sont
## dans le sous-dossier datasets/ et les sorties vont dans outputs/ — tous
## les chemins sont relatifs à ce dossier.
##
## 1. Une fois : source("install_packages_day.R") (packages du jour). 2.
## Vérifier que datasets/ contient bien les fichiers listés dans le README du
## jour. 3. Cliquer Render. Les imports protégés par file.exists() laissent
## le rendu aboutir même si une donnée manque (la sortie concernée affiche
## alors un message).
##
## ----------------------------------------------------------------------
