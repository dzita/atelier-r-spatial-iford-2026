...
#
# Regle 6.6 : aucune installation pendant le rendu. Une boucle
# install.packages() executee a chaque rendu a deux defauts :
#   - elle reinstalle en cours de rendu, ce qui peut durer des dizaines de
#     minutes et echouer sans reseau, en pleine seance ;
#   - elle finit par installer des paquets que la journee ne charge JAMAIS
#     (tmaptools, tidyr, leaflet, mapview, spatialreg, gstat appartiennent
#     au J05, J06 et J11).
# L'installation se fait donc UNE FOIS, hors rendu, par
...
#   # c'est voulu, le lecteur de la carte doit voir ou la mesure n'existe pas.
#   tm_fill(fill = 'gi_class',
#           fill.scale = tm_scale_categorical(values = palette_gi),
#           fill_alpha = 0.7,
...
#
# MIGRATION TMAP 4 - A VERIFIER : popup.vars et tm_basemap(server = ) sont repris de la v3 ; ce bloc n'etant jamais execute au rendu, leur nom exact en v4 se controle en salle, a la premiere execution interactive.
